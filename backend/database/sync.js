        ...
        await Prestataire.bulkCreate([
            {
                ...
                nom_en: 'Games and Entertainment',
                description: "Espace dédié aux jeux pour enfants et adultes avec diverses animations...",
                description_en: "A space dedicated to games for children and adults with various activities...",
                description_accueil: 'Jeux et animations pour tous.',
                description_accueil_en: 'Games and entertainment for everyone.',
                id_categorie: 1,
                id_emplacement: 1,
                id_evenement: 1,
                page_route: '/prestataire/1',
                image: convertImageToBase64('test/ImagesPrestataires/jeu_divertissement.jpg'),
                accepted: true,
                id_utilisateur: 2
            },
            {
                nom: 'Restaurant Le Gourmet',
                nom_en: 'Le Gourmet Restaurant',
                description: "Restaurant proposant une variété de plats traditionnels et internationaux...",
                description_en: "A restaurant offering a variety of traditional and international dishes...",
                description_accueil: 'Cuisine variée et ingrédients locaux.',
                description_accueil_en: 'Varied cuisine and local ingredients.',
                id_categorie: 2,
                id_emplacement: 2,
                id_evenement: 1,
                page_route: '/prestataire/2',
                image: convertImageToBase64('test/ImagesPrestataires/restaurant.jpg'),
                accepted: true,
                id_utilisateur: 5
            },
            {
                nom: 'Mascotte Festival',
                nom_en: 'Festival Mascot',
                description: "Notre mascotte officielle anime le festival et pose pour des photos...",
                description_en: "Our official mascot entertains the festival and poses for pictures...",
                description_accueil: 'Animations et photos avec la mascotte.',
                description_accueil_en: 'Entertainment and photos with the mascot.',
                id_categorie: 3,
                id_emplacement: 3,
                id_evenement: 1,
                page_route: '/prestataire/3',
                image: convertImageToBase64('test/ImagesPrestataires/mascotte.jpg'),
                accepted: true,
                id_utilisateur: 6
            },
            {
                nom: 'Stand Artisanat Local',
                nom_en: 'Local Crafts Stand',
                description: "Découvrez et achetez des produits artisanaux locaux fabriqués par nos prestataires...",
                description_en: "Discover and purchase local handcrafted products made by our vendors...",
                description_accueil: 'Produits artisanaux uniques.',
                description_accueil_en: 'Unique handcrafted products.',
                id_categorie: 1,
                id_emplacement: 4,
                id_evenement: 1,
                page_route: '/prestataire/4',
                image: convertImageToBase64('test/ImagesPrestataires/stand.jpg'),
                accepted: true,
                id_utilisateur: 7
            },
            {
                ...
                nom_en: 'Duck Tasting',
                description: "Venez déguster une variété de plats à base de canard, préparés par des chefs renommés...",
                description_en: "Come and taste a variety of duck-based dishes prepared by renowned chefs...",
                description_accueil: 'Dégustation de plats à base de canard.',
                description_accueil_en: 'Tasting of duck-based dishes.',
                id_categorie: 3,
                id_emplacement: 5,
                id_evenement: 1,
                page_route: '/prestataire/5',
                image: convertImageToBase64('test/ImagesPrestataires/degustation_canard.jpg'),
                accepted: true,
                id_utilisateur: 8
            },
            {
                nom: 'Concours de Cuisine',
                nom_en: 'Cooking Contest',
                description: "Participez ou assistez à un concours de cuisine où des chefs amateurs et professionnels...",
                description_en: "Participate in or watch a cooking contest where amateur and professional chefs...",
                description_accueil: 'Concours de cuisine autour du canard.',
                description_accueil_en: 'Cooking contest around duck-based dishes.',
                id_categorie: 4,
                id_emplacement: 6,
                id_evenement: 1,
                page_route: '/prestataire/6',
                image: convertImageToBase64('test/ImagesPrestataires/concours_cuisine_canard.jpg'),
                accepted: true,
                id_utilisateur: 9
            },
            {
                nom: 'Atelier Peinture',
                nom_en: 'Painting Workshop',
                description: "Découvrez l'art de la peinture sur canard. Participez à cet atelier unique...",
                description_en: "Discover the art of duck painting. Participate in this unique workshop...",
                description_accueil: 'Atelier de peinture sur canard.',
                description_accueil_en: 'Duck painting workshop.',
                id_categorie: 1,
                id_emplacement: 7,
                id_evenement: 1,
                page_route: '/prestataire/7',
                image: convertImageToBase64('test/ImagesPrestataires/atelier_peinture_canard.jpg'),
                accepted: true,
                id_utilisateur: 10
            },
            {
                nom: "Ped'ailo!",
                nom_en: "Ped'ailo!",
                description: "Avec Ped'ailo, prenez vos ailes et flottez comme un canard sur les étangs...",
                description_en: "With Ped'ailo, take your wings and float like a duck on the ponds...",
                description_accueil: 'Stand de pédalo sur les étangs',
                description_accueil_en: 'Pedal boat stand on the ponds',
                id_categorie: 1,
                id_emplacement: 8,
                id_evenement: 1,
                page_route: '/prestataire/8',
                image: convertImageToBase64('test/ImagesPrestataires/pedalo_canard.jpg'),
                accepted: true,
                id_utilisateur: 11
            },
            {
                nom: 'Goodies & Souvenirs',
                nom_en: 'Goodies & Souvenirs',
                description: "Boutique spécialisée dans les souvenirs et objets promotionnels du festival...",
                description_en: "A shop specializing in festival souvenirs and promotional items...",
                description_accueil: 'Goodies et souvenirs du festival.',
                description_accueil_en: 'Festival goodies and souvenirs.',
                id_categorie: 4,
                id_emplacement: 3,
                id_evenement: 1,
