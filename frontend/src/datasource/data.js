...
// Accessoire et Lifestyle
    {
        id: 1,
        nom: "Badge Festival",
        description: "Badge officiel du festival.",
        prix: 2,
        tailles: ["Unique"],
        couleurs: ["Jaune"],
        stock: 100,
    ...
    },
    {
        id: 2,
        nom: "Badge Duo",
        description: "Set de 2 badges en édition limitée.",
        prix: 4,
        tailles: ["Unique"],
    ...
    },
    {
        id: 3,
        nom: "Badge Trio",
        description: "Set de 3 badges exclusifs pour les collectionneurs.",
        prix: 6,
        tailles: ["Unique"],
        couleurs: ["Multicolore"],
        stock: 30,
    ...
    },
    {
        id: 4,
        nom: "Coque Téléphone",
        description: "Coque design avec motif de canard.",
        prix: 12,
    ...
    },
    {
        ...
        description: "Coque fantaisie avec design unique.",
        prix: 14,
        tailles: ["iPhone"],
        couleurs: ["Vert", "Bleu"],
        stock: 50,
    ...
    },
    {
        id: 6,
        nom: "Coque Premium",
        description: "Coque premium avec un style épuré.",
        prix: 16,
        tailles: ["Samsung"],
        couleurs: ["Blanc", "Gris"],
        stock: 40,
    ...
    },
    {
        id: 7,
        nom: "Coque Luxe",
        description: "Coque de luxe avec détails dorés.",
        prix: 20,
        tailles: ["iPhone", "Samsung"],
        couleurs: ["Or", "Noir"],
        stock: 30,
    ...
    },
    {
        ...
        description: "Coque rare pour les amateurs de design.",
        prix: 22,
        tailles: ["iPhone"],
        couleurs: ["Rouge", "Bleu"],
        stock: 20,
    ...
    },
    {
        id: 9,
        nom: "Gourde Canard",
        description: "Gourde écologique avec motif canard.",
        prix: 15,
        tailles: ["500ml", "1L"],
        couleurs: ["Jaune"],
        stock: 70,
    ...
    },
    {
        id: 10,
        nom: "Lunettes Jaunes",
        description: "Lunettes amusantes en forme de canard.",
        prix: 8,
        tailles: ["Unique"],
        couleurs: ["Jaune"],
        stock: 90,
    ...
    },
    {
        ...
        description: "Lunettes fantaisie pour les festivaliers.",
        prix: 10,
        tailles: ["Unique"],
        couleurs: ["Multicolore"],
        stock: 60,
    ...
    },
    {
        ...
        description: "Lunettes stylées pour les soirées du festival.",
        prix: 12,
        tailles: ["Unique"],
        couleurs: ["Bleu", "Vert"],
        stock: 50,
    ...
    },
    {
        id: 13,
        nom: "Mug Festival",
        description: "Mug officiel avec logo du festival.",
        prix: 10,
        tailles: ["Standard"],
    ...
    },
    {
        id: 14,
        nom: "Mug Collector",
        description: "Mug pour les collectionneurs du festival.",
        prix: 12,
        tailles: ["Standard"],
        couleurs: ["Noir", "Rouge"],
        stock: 40,
    ...
    },
    {
        ...
        description: "Mug rare en série limitée.",
        prix: 15,
        tailles: ["Standard"],
        couleurs: ["Bleu", "Vert"],
        stock: 30,
    ...
    },
    {
        ...
        description: "Parapluie avec motif canard pour les jours de pluie.",
        prix: 18,
        tailles: ["Unique"],
        couleurs: ["Jaune", "Bleu"],
        stock: 40,
    ...
    },
    {
        ...
        description: "Parapluie compact facile à transporter.",
        prix: 20,
        tailles: ["Unique"],
        couleurs: ["Noir", "Rouge"],
        stock: 30,
    ...
    },
    {
        id: 18,
        nom: "Parapluie Luxe",
        description: "Parapluie élégant pour les festivaliers.",
        prix: 25,
        tailles: ["Unique"],
    ...
    },
    {
        ...
        description: "Porte-clé mignon en forme de canard.",
        prix: 5,
        tailles: ["Unique"],
        couleurs: ["Jaune"],
        stock: 100,
    ...
    },
    {
        ...
        description: "Porte-clé pour les amateurs du festival.",
        prix: 6,
        tailles: ["Unique"],
        couleurs: ["Blanc", "Noir"],
        stock: 80,
    ...
    },
    {
        id: 21,
        nom: "Porte-clé Luxe",
        description: "Porte-clé en édition limitée avec logo.",
        prix: 8,
        tailles: ["Unique"],
        couleurs: ["Or", "Argent"],
        stock: 50,
    ...
    // Aliments
    {
        ...
        description: "Biscuits décorés pour le festival.",
        prix: 5,
        tailles: ["Pack de 10"],
        couleurs: ["Doré"],
        stock: 60,
    ...
    },
    {
        ...
        description: "Chocolats artisanaux avec design unique.",
        prix: 7,
        tailles: ["Boîte de 6"],
        couleurs: ["Marron"],
        stock: 50,
...
// Objet Cinéma et Tech
    {
        ...
        description: "Écouteurs stylés avec design inspiré du canard.",
        prix: 25,
        tailles: ["Standard"],
    ...
    },
    {
        ...
        description: "Écouteurs premium pour une qualité sonore exceptionnelle.",
        prix: 35,
        tailles: ["Standard"],
        couleurs: ["Noir", "Rouge"],
        stock: 20,
    ...
    },
    {
        id: 26,
        nom: "Clap de Cinéma",
        description: "Mini clap de cinéma pour les passionnés de film.",
        prix: 10,
        tailles: ["15x15 cm"],
        couleurs: ["Noir", "Blanc"],
        stock: 40,
    ...
    },
    {
        ...
        description: "Clé USB 32GB avec le logo officiel du festival.",
        prix: 12,
        tailles: ["32GB"],
        couleurs: ["Noir", "Jaune"],
        stock: 80,
    ...
    },
    {
        ...
        description: "Clé USB édition limitée avec un design unique.",
        prix: 15,
        tailles: ["64GB"],
        couleurs: ["Argent", "Or"],
        stock: 50,
    ...
    },
    {
        id: 29,
        nom: "Vinyle Festival",
        description: "Vinyle de la bande sonore officielle du festival.",
        prix: 20,
        tailles: ["33 Tours"],
        couleurs: ["Noir"],
        stock: 35,
    ...
    },
    {
        ...
        description: "Vinyle édition collector avec design exclusif.",
        prix: 30,
        tailles: ["33 Tours"],
...
// Papeterie et Collection
    {
        id: 31,
        nom: "Carnet Festival",
        description: "Carnet de notes avec couverture inspirée du festival.",
        prix: 6,
        tailles: ["A5"],
        couleurs: ["Jaune", "Vert"],
        stock: 50,
    ...
    },
    {
        ...
        description: "Carnet premium pour les collectionneurs.",
        prix: 8,
        tailles: ["A5"],
        couleurs: ["Bleu", "Rouge"],
        stock: 40,
    ...
    },
    {
        ...
        description: "Carte postale officielle du festival.",
        prix: 2,
        tailles: ["10x15 cm"],
        couleurs: ["Multicolore"],
        stock: 100,
    ...
    },
    {
        ...
        description: "Carte postale en édition limitée.",
        prix: 3,
        tailles: ["10x15 cm"],
        couleurs: ["Blanc", "Noir"],
        stock: 70,
    ...
    },
    {
        ...
        description: "Marque-page élégant pour vos livres.",
        prix: 2,
        tailles: ["Unique"],
        couleurs: ["Jaune", "Bleu"],
        stock: 80,
    ...
    },
    {
        id: 36,
        nom: "Stylo Festival",
        description: "Stylo officiel pour prendre des notes durant le festival.",
        prix: 3,
        tailles: ["Standard"],
        couleurs: ["Noir", "Jaune"],
        stock: 100,
    ...
    // Premium
    {
        ...
        description: "Catalogue officiel en édition limitée.",
        prix: 15,
        tailles: ["A4"],
        couleurs: ["Blanc"],
        stock: 20,
    ...
    },
    {
        id: 38,
        nom: "Mini Palme d'Or",
        description: "Réplique en or du trophée emblématique.",
        prix: 50,
        tailles: ["10 cm"],
        couleurs: ["Or"],
        stock: 10,
...
// Textiles et Modes
    {
        ...
        description: "T-shirt officiel du Festival de Cannes.",
        prix: 18,
        tailles: ["S", "M", "L", "XL"],
        couleurs: ["Blanc", "Jaune"],
        stock: 60,
    ...
    },
    {
        ...
        description: "T-shirt en édition limitée pour les fans.",
        prix: 20,
        tailles: ["S", "M", "L", "XL"],
        couleurs: ["Noir", "Gris"],
        stock: 50,
    ...
    },
    {
        ...
        description: "Sweat-shirt confortable avec logo festival.",
        prix: 35,
        tailles: ["M", "L", "XL"],
        couleurs: ["Gris", "Bleu"],
        stock: 50,
    ...
    },
    {
        ...
        description: "Sweat-shirt classique avec design minimaliste.",
        prix: 38,
        tailles: ["M", "L", "XL"],
        couleurs: ["Noir", "Blanc"],
        stock: 40,
    ...
    },
    {
        ...
        description: "Sweat-shirt rare pour les fans.",
        prix: 40,
        tailles: ["M", "L"],
        couleurs: ["Rouge", "Bleu"],
        stock: 30,
    ...
    },
    {
        id: 44,
        nom: "Bob Festival",
        description: "Bob tendance avec logo du festival.",
        prix: 15,
        tailles: ["Unique"],
        couleurs: ["Jaune", "Bleu"],
        stock: 70,
    ...
    },
    {
        id: 45,
        nom: "Bob Classique",
        description: "Bob classique avec design épuré.",
        prix: 16,
        tailles: ["Unique"],
        couleurs: ["Noir", "Blanc"],
        stock: 60,
    ...
    },
    {
        ...
        description: "Bob en édition spéciale pour le festival.",
        prix: 18,
        tailles: ["Unique"],
        couleurs: ["Vert", "Rouge"],
        stock: 40,
    ...
    },
    {
        id: 47,
        nom: "Bob Fantaisie",
        description: "Bob fantaisie pour un style unique.",
        prix: 20,
        tailles: ["Unique"],
    ...
    },
    {
        ...
        description: "Écharpe chaude et stylée avec logo.",
        prix: 25,
        tailles: ["Unique"],
    ...
    },
    {
        id: 49,
        nom: "Écharpe Hiver",
        description: "Écharpe idéale pour l'hiver.",
        prix: 28,
        tailles: ["Unique"],
        couleurs: ["Gris", "Bleu"],
        stock: 35,
    ...
    },
    {
        ...
        description: "Sac écologique avec motif canard.",
        prix: 12,
        tailles: ["Standard"],
        couleurs: ["Blanc", "Jaune"],
        stock: 80,
    ...
    },
    {
        ...
        description: "Sac pratique pour vos courses.",
        prix: 14,
        tailles: ["Standard"],
        couleurs: ["Vert", "Noir"],
        stock: 60,
    ...
    },
    {
        ...
        description: "Sac rare pour les collectionneurs.",
        prix: 16,
        tailles: ["Standard"],
        couleurs: ["Rouge", "Bleu"],
        stock: 40,
